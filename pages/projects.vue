<template>
    <Head>
        ...
        <Link rel="sitemap" :href="requestUrl.origin + '/sitemap.xml'" type="application/xml" />
        ...
        <Meta property="og:image" :content="constants.facebook_open_graph.image" />
...
export default {
    data() {
        return {
            title: "Projects" + constants.main.second_title, 
            description: "As a programming enthusiast, Andrea often launches new projects to experiment with new technologies/frameworks and tries to solve small everyday problems.", 
            nuxtApp: useNuxtApp(),
