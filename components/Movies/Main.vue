    ...
    <div class="container page-content">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <h1>Movies</h1>
                <p>Below is my Blu-ray, DVD, and VHS collection, along with films I’ve only seen. The list highlights
                    both the movies I own and those I’ve experienced but don’t yet possess.
                </p>
            </div>
        </div>
            ...
            <div class="col-lg-12 mb-4">
                <form>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="all" checked v-model="selectedOption"
                            @change="changeSelectedOption">
                        <label class="form-check-label">All</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" value="owned" v-model="selectedOption"
                            @change="changeSelectedOption">
